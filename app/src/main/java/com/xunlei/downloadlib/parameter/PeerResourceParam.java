...
public class PeerResourceParam {
    public static final int PEER_RES_TYPE_DCDN = 5;
    public static final int PEER_RES_TYPE_LAN = 8;
    public static final int PEER_RES_TYPE_NORMAL = 3;
